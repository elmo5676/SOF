...
class CoreDataTesterViewController: UIViewController, JSONLoaderDelagate, JsonCounterDelegate {
    ...
    @IBAction func b3(_ sender: UIButton) {
        let ac = NewAircraft(appTypeCapable: [.ILS, .TACAN,.VOR_NO_DME, .VOR_BASED_ON_VORDME_OR_VORTAC], appCategory: [.E], minRunwayLength: 7000, maxCrossWind: 15, maxSustainedWind: 30)
        let alt = Alternate(icao: "KAVL", aircraft: ac)

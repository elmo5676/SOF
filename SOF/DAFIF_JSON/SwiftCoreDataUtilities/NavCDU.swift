		...
		pc.performBackgroundTask { moc in
				...
				do {
					...
					for nav_CD in results {
						...
						nav_CD_DB.cycleDate_CD = nav_CD.cycleDate
					...
					DispatchQueue.main.async {
						log.info("Nav_CD Done Loading into CoreData")
